...
- Ask what someone will use this file for. Instructions for running the project belong with project information, in a clearly named project information/instructions folder if needed. A partly filled setup draft belongs in Working-Files. A document of fictional examples and its example pictures belong together as examples, not as business research or unfinished designs. Research supplies findings; source files supply material to edit. Blank information templates stay blank unless facts are supported.
